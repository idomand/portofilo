      ...
      <ProjectContentWrapper>
        <Div>
          ...
          <UL>
            ...
            <ListItem>
              I also love TypeScript and Next.js, and I wanted to build a basic
              design system for myself.
            </ListItem>
          </UL>
        ...
        <DivRight>
          ...
          <UL>
            <ListItem>
              This project is a PWA so it can be used like a native app.
            </ListItem>
            <ListItem>
